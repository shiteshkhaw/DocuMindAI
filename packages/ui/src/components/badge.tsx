      ...
      <span
        ...
        className={cn(
          "inline-flex items-center rounded-full px-2.5 py-0.5 text-[10px] font-medium tracking-wide uppercase transition-colors duration-200",
          {
            ...
            "bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 animate-pulse-subtle": variant === "warning",
            "bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20": variant === "error",
            "bg-sky-500/10 text-sky-600 dark:text-sky-400 border border-sky-500/20": variant === "info",
          },
          className
        )}
        {...props}
